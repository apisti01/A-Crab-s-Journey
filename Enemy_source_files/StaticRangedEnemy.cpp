...
StaticRangedEnemy::StaticRangedEnemy(int id, std::string name, const sf::Texture &texture, Collider collider,
                                     ...
                                     int coinsDropped, int pearlsDropped, int attackTimer, float units) :
